...
alter table HallCapacity
    ...
    #add constraint seatCountSizes
	#	check(sum(SeatCount) in (200, 250, 300))
    ;
...
insert into HallCapacity (HallId, SeatTypeId, SeatCount)
	values	(1, 1, 25),
            ...
            (3, 3, 175)
            ;
#<<-- create constraint on total seats after hallcapacity data is populated
